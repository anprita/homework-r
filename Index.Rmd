...
<ul>
  ...
  <li>Supria : Correlation between length of hindfoot and weight of animal</li>
  <li>Supria : Changes of weight over the year based on each plot type</li>
  <li>Supria : Changes of length of hindfoot  over the year based on each plot      type</li>
